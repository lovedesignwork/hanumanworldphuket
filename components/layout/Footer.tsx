...
const footerLinks = {
  ...
  activities: [
    ...
    { name: 'Hanuman Luge', href: '/booking?package=luge' },
  ],
  company: [
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-foreground-muted">
                ...
                <span className="text-sm">105 Moo 4, Chaofa West Road, Chalong, Muang, Phuket 83130</span>
              </li>
              <li className="flex items-center gap-2 text-foreground-muted">
                <Phone className="w-4 h-4 text-accent flex-shrink-0" />
                <a href="tel:+66629795533" className="hover:text-accent transition-colors text-sm">
                  +66 62 979 5533
                </a>
              </li>
              <li className="flex items-center gap-2 text-foreground-muted">
                <Mail className="w-4 h-4 text-accent flex-shrink-0" />
                <a href="mailto:support@hanumanworldphuket.com" className="hover:text-accent transition-colors text-sm">
