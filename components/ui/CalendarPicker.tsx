    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        ...
        <button
          ...
          className="w-full h-11 pl-10 pr-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#1a237e] text-left"
        >
