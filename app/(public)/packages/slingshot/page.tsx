...
export const metadata: Metadata = {
  title: 'Slingshot',
  description: 'Experience the ultimate adrenaline rush with our human slingshot at Hanuman World Phuket.',
};
      ...
      <Section className="bg-gradient-to-b from-primary-dark to-background-dark">
        <Container size="lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <Badge variant="accent" className="mb-4">EXTREME THRILL</Badge>
