          ...
          <div className="p-6 md:p-8">
            ...
            <div className="space-y-3 mb-8">
              ...
              <Link href="/booking" className="block">
                <div className="flex items-center gap-4 p-4 bg-[#1a237e]/5 hover:bg-[#1a237e]/10 rounded-xl transition-colors cursor-pointer">
            ...
            <div className="pt-6 border-t border-slate-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
                ...
                <a
                  href="mailto:info@hanumanworldphuket.com"
                  className="flex items-center justify-center gap-2 p-3 bg-slate-50 hover:bg-slate-100 rounded-xl transition-colors"
                >
