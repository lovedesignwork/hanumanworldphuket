...
export const BookingConfirmationEmail = ({
  ...
  const previewText = `Your Hanuman World adventure is confirmed! Booking #${bookingRef}`;
        ...
        <Container style={container}>
          ...
          <Section style={successBanner}>
            ...
            <Text style={successSubtitle}>
              Thank you for choosing Hanuman World, {customerName}!
            </Text>
          </Section>
          ...
          <Section style={contactSection}>
            ...
            <Text style={contactText}>
              📧 Email: <Link href="mailto:info@hanumanworldphuket.com" style={contactLink}>info@hanumanworldphuket.com</Link>
            </Text>
            <Text style={contactText}>
          ...
          <Section style={footer}>
            ...
            <Row style={socialRow}>
              <Column style={socialCol}>
                <Link href="https://www.facebook.com/hanumanworldphuket" style={socialLink}>
                  Facebook
                </Link>
              </Column>
              <Column style={socialCol}>
                <Link href="https://www.instagram.com/hanumanworldphuket" style={socialLink}>
                  Instagram
                </Link>
              </Column>
              <Column style={socialCol}>
                <Link href="https://www.tripadvisor.com/Attraction_Review-g1215780-d4788183-Reviews-Hanuman_World-Kathu_Phuket.html" style={socialLink}>
                  TripAdvisor
                </Link>
              </Column>
            </Row>
            ...
            <Text style={footerCopyright}>
              © 2026 Hanuman World Phuket. All rights reserved.
            </Text>
          </Section>
        </Container>
      </Body>
